...
const InvoiceComponent = ({ userId }) => {
  ...
  const generatePDF = () => {
    ...
    doc.setFont("helvetica", "bold");
    doc.setTextColor(44, 62, 80);
    doc.text("Real Estate Agency", margin, 40);
    doc.setFont("helvetica", "normal");
    doc.setFontSize(9);
    doc.text("123 Business Avenue, City", margin, 45);
    doc.text("Email: contact@realestateagency.com", margin, 50);
    doc.text("Phone: +1 123-456-7890", margin, 55);
  ...
  // Show user ID debug info if there's an error
  if (error) {
    return (
      <div
        ...
        <div className="flex">
          ...
          <div>
            ...
            <p className="mt-2 text-sm">
              UserID: {userId ? userId : "Not available"} ({typeof userId})
            </p>
            <button
